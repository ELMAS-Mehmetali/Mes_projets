...
<body>
    ...
    <section class="contenu-publications">
            <h2>DERNIERES PUBLICATIONS - SÉANCES</h2>
            <ul class="publication-list">
                <?php
                    foreach ($mesSeances as $maSeance) {
                        ...
                        echo '<li>
                    <span class="publication-title">'.$maSeance['nom_seance'].'</span>
                    <span class="publication-niveau">'.$niveau.'</span>
                    <span class="publication-categorie">'.$categorie.'</span>
                    <span class="publication-date">01 juin 2025</span>
                    <a href="./modif_seances_coach.php?id_seance='.$maSeance['id_seance'].'"><button type="button">MODIFIER</button></a>
                </li>';
                    }
                ?>
                <!-- <li>
