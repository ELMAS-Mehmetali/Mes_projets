...
<body>
    ...
    <main>
        <section class="page_header">
            <h1>SÉANCES</h1>
            <h2>Trouvez le sport qui vous motive et transforme votre quotidien.</h2>
        </section>
            ...
            <div class="filtres">
                <div class="filtre-group">
                    <div class="filtre-header">
                        <img src="../assets/image/pictogramme/categorie.svg" alt="picto categorie" class="icon">
                        <span class="filtre-titre">Catégories</span>
                    </div>
                    <div class="options">
                        <label><input type="radio" name="categorie" value="Musculation"> Musculation</label>
                        <label><input type="radio" name="categorie" value="HIIT"> HIIT</label>
                        <label><input type="radio" name="categorie" value="Running"> Running</label>
                    </div>
                </div>
                <div class="filtre-group">
                    <div class="filtre-header">
                        <img src="../assets/image/pictogramme/level.svg" alt="picto niveau" class="icon">
                        <span class="filtre-titre">Niveau</span>
                    </div>
                    <div class="options">
                        <label><input type="radio" name="niveau" value="Débutant"> Débutant</label>
        ...
        <?php
            foreach ($mesSeances as $maSeance) {
                        $niveau = $seance->getNiveau($maSeance['id_niveau']);
                        $categorie = $seance->getCategorie($maSeance['id_cat_seance']);
                        $coachNom = $seance->getCoachNom($maSeance['id_utilisateur']);
                        $coachPrenom = $seance->getCoachPrenom($maSeance['id_utilisateur']);
                            ...
                            '<section class="card">
                                <div class="seance-nutrition-card">
                                    <div class="card-header">
                                        ...
                                        <span class="tag">'.$maSeance['nom_seance'].'</span>
                                    </div>
                                    <div class="card-body">
                                        <img src="../assets/image/seance/press.jpg" alt="Séance Jambes">
                                        <div class="details">
                                            <div class="infos">
                                                <img src="../assets/image/pictogramme/level.svg" alt="">
                                                <span>'.$niveau.'</span>
                                            </div>
                                            <div class="infos">
                                                <img src="../assets/image/pictogramme/duree.svg" alt="">
                                                <span>'.$maSeance['duree_seance'].'</span>
                                            </div>
                                            <div class="infos">
                                                <img src="../assets/image/pictogramme/coach.svg" alt="">
                                                <span>'.$coachPrenom.' '.strtoupper(substr($coachNom, 0, 1)).'.</span>
                                            </div>
                                        </div>
                                        <div class="description">
                                            <p>'.$maSeance['description_seance'].'</p>
                                        </div>
                                        <div class="card-btn">LET\'S GO !</div>
                                    </div>
                                </div>
                            </section>';
                        }
        ...
        <!-- <section class="card">
            <div class="seance-nutrition-card">
                <div class="card-header">
                    ...
                    <span class="trait">|</span>
                    <span class="tag">SÉANCES JAMBES</span>
                </div>
                <div class="card-body">
                    <img src="../assets/image/seance/press.jpg" alt="Séance Jambes">
                    <div class="details">
        ...
        <section class="page_nutrition_seance">
          <div class="card_nutrition_seance">
            <div class="image_page_chaine">
              <img src="../assets/image/seance/recette_page_seance.jpg" alt="livre de recette">
            </div>
            <div class="intro_nutrition_seance">
                <h2>Venez découvrir nos idées de recette...</h2>
                <p>Vous voulez maximiser vos résultats et transformer vos efforts sportifs en succès durables ? Découvrez comment une nutrition adaptée peut faire toute la différence. Rendez-vous sur notre page nutrition pour explorer des plans personnalisés qui soutiennent vos objectifs, qu’il s’agisse de prise de masse, de perte de poids ou simplement d’un mode de vie plus sain.</p>
                <div class="card-btn"><a href="./nutrition.php">LET'S GO !</a></div>
            </div>
          </div>
        </section>
